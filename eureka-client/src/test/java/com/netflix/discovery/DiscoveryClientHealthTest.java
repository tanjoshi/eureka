...
public class DiscoveryClientHealthTest extends AbstractDiscoveryClientTester {
    ...
    public void testCallback() throws Exception {
        ...
        Assertions.assertEquals(InstanceInfo.InstanceStatus.STARTING, clientImpl.getInstanceInfo().getStatus(), "Instance info status not as expected.");
        ...
        Assertions.assertEquals(InstanceInfo.InstanceStatus.OUT_OF_SERVICE, clientImpl.getInstanceInfo().getStatus(), "Instance info status not as expected.");
        ...
        Assertions.assertEquals(InstanceInfo.InstanceStatus.DOWN, clientImpl.getInstanceInfo().getStatus(), "Instance info status not as expected.");
        myCallback.reset();
        instanceInfoReplicator.run();

        Assertions.assertTrue(myCallback.isInvoked(), "Healthcheck callback not invoked.");
        Assertions.assertEquals(InstanceInfo.InstanceStatus.UP, clientImpl.getInstanceInfo().getStatus(), "Instance info status not as expected.");
    }
    ...
    public void testHandler() throws Exception {
        ...
        Assertions.assertEquals(InstanceInfo.InstanceStatus.UP, clientImpl.getInstanceInfo().getStatus(), "Instance info status not as expected post healthcheck.");
        ...
        Assertions.assertEquals(InstanceInfo.InstanceStatus.DOWN, clientImpl.getInstanceInfo().getStatus(), "Instance info status not as expected post healthcheck.");
    }
