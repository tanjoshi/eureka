...
public class InstanceRegistryTest extends AbstractTester {
    ...
    public void testGetAppsDeltaFromAllRemoteRegions() throws Exception {
        ...
        Assertions.assertEquals(1, localApplication.getInstances().size(), "Local registry app instance count in delta not as expected.");
        Assertions.assertNotNull(remApplication, "Did not find remote registry app in delta");
        Assertions.assertEquals(1, remApplication.getInstances().size(), "Remote registry app instance count  in delta not as expected.");
    }
    ...
    public void testGetAppsFromBothRegions() throws Exception {
        ...
        Assertions.assertEquals(1, locaApplication.getInstances().size(), "Local registry app instance count not as expected.");
        Assertions.assertNotNull(remApplication, "Did not find remote registry app");
        Assertions.assertEquals(2, remApplication.getInstances().size(), "Remote registry app instance count not as expected.");
